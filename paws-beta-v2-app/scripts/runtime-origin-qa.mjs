...
try{
  ...
  try{await page.waitForFunction(()=>{const a=window.__POTR_QA__.visualAssets;return a.sofa&&a.coffee&&a.environment&&a.errors.length===0;},null,{timeout:8000});}catch{}
  const assets=await page.evaluate(()=>window.__POTR_QA__.visualAssets);
