...
const PIECES = {
  kitchen: [
    ...
    ['toybox', 3.45, -2.5, 1.3, 0.78, 0.58], ['arch', 0, 5.6, 3.0, 0.45, 2.3]
  ],
  sunroom: [
...
const LEVELS = [
  {id:'ch1-l1',chapter:1,name:'Snack Run',theme:'kitchen',seed:101,parTime:42,targetScore:520,objectives:[['orange','Knock the tea towel',-2.2,-2.6,13],['gray','Tap the toy box',3.45,-1.85,12],['orange','Reach the sunny rug',0.0,4.35,14]]},
  ...
  {id:'ch1-l4',chapter:1,name:'Henley Hustle',theme:'kitchen',seed:404,parTime:48,targetScore:920,objectives:[['gray','Slip past the stool',-1.7,-1.35,10],['orange','Reach the toy box',3.45,-1.85,10],['gray','Touch the right plant',4.35,2.55,10],['orange','Escape to the arch',0,5.0,10]]},
